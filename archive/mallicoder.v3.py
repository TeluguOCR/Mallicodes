...
CodeLens = (0, 16, 5, 4, 1, 11, 12, 
               16, 5, 4, 1, 4)      
CodeIndices = list(map(lambda x:sum(CodeLens[:x]), range(len(CodeLens)))) # Just accumulate above
CodeNames   = ('LETTER', 'TC',  'TA',   'TM', 'TV', 'TL', 'SD', 
         'BC',  'BA',   'BM', 'BV', 'TR')

Codes = {
'ka':   ['క',	   0x9286, 0x15,   0x2,	0x0,	0xc1,   0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'kha':  ['ఖ',	   0xf2f5, 0x2,	0x8,	0x1,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'ja':   ['జ',	   0x7cdc, 0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'jha':  ['ఝ',	   0x32cc, 0xa,	0x8,	0x0,	0xc1,   0x3,	0x0,	0x0,	0x0,	0x0,	0x8], 
...
'ṇa':   ['ణ',	   0xb3fc, 0x2,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'ta':   ['త',	   0x8696, 0xe,	0x0,	0x0,	0xc1,   0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'bha':  ['భ',	   0x72dc, 0x2,	0x0,	0x1,	0xc1,   0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'ma':   ['మ',	   0x02fc, 0x3,	0x0,	0x0,	0xc1,   0x3,	0x0,	0x0,	0x0,	0x0,	0x0], 
'ya':   ['య',	   0x32cc, 0xa,	0x8,	0x0,	0xc1,   0x3,	0x0,	0x0,	0x0,	0x0,	0x0], 
'mau':  ['మౌ',  0x02fc, 0x3,	0x0,	0x0,	0xeb,   0x3,	0x0,	0x0,	0x0,	0x0,	0x0], 
'yau':  ['యౌ',  0x32cc, 0xa,	0x8,	0x0,	0xeb,   0x3,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'śa':   ['శ',	   0x061f, 0x1,	0x3,	0x0,	0xc1,   0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'ī':	['ఈ',	   0x1284, 0x1f,   0x7,	0x0,	0x0,	0x7,	0x0,	0x0,	0x0,	0x0,	0x0], 
'u':	['ఉ',	   0x10cc, 0x19,   0x3,	0x0,	0x200,  0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'ū':	['ఊ',	   0x10cc, 0x19,   0x7,	0x0,	0x240,  0x7,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'ē':	['ఏ',	   0x02bc, 0x0,	0x0,	0x0,	0x200,  0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'ai':   ['ఐ',	   0x33fc, 0x2,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'o':	['ఒ',	   0x70dc, 0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'ō':	['ఓ',	   0x71dc, 0x0,	0x0,	0x0,	0x200,  0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
'au':   ['ఔ',	   0x72dc, 0x0,	0x0,	0x0,	0x6b,   0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'+ra1': ['్ర౧',	 0x0,	0x0,	0x8,	0x1,	0x0,	0x0,	0x0800, 0x0,	0x2,	0x0,	0x0], 
'+ra':  ['్ర',	  0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x8400, 0x0,	0x2,	0x0,	0x0], 
'+ra2': ['్ర౩',	 0x0f00, 0x0,	0x2,	0x0,	0x0,	0x0,	0x0400, 0x0,	0x0,	0x0,	0x8], 
'+la':  ['్ల',	  0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0xb700, 0x0,	0x0,	0x0,	0x0], 
'+va':  ['్వ',	  0x2,	0x0,	0x4,	0x0,	0x0,	0x0,	0xfc00, 0x0,	0x0,	0x0,	0x0], 
'+r̥':  ['ృ',	   0x02,   0x0,	0x0,	0x0,	0x0,	0x0,	0x0f00, 0x0,	0x0,	0x0,	0x8], 
'+r̥̄': ['ౄ',	   0x02,   0x0,	0x4,	0x0,	0x0,	0x0,	0x0f00, 0x0,	0x0,	0x0,	0x8], 
...
'+ḷa':  ['్ళ',	  0x2,	0x0,	0x0,	0x0,	0x0,	0x0,	0xf60f, 0x0,	0x2,	0x0,	0x8], 
...
'1':	['1',	   0x2000, 0x4,	0x8,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
'7':	['7',	   0x600,  0x11,   0x8,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0,	0x0], 
...
def code2list(ntuple):
    ...
    # Fix పాఫొసోషౌ
    if ntuple[LETTER] in ('పా','పొ','పో','పౌ','ఫా','ఫొ','ఫో','ఫౌ','సా','సొ','సో','సౌ','షా','షొ','షో','షౌ',):
        print ("Adding extra bit for", ntuple[LETTER])
...
def delredundants(lcode):
    ...
    redundants = [IDX_BOTMID+3, IDX_BOTMID+1, 
                  ...
                  CodeIndices[TRANSITION]+3] + \
                  list(range(IDX_SIDE+2, IDX_SIDE+8))
...
Sides = ('+u', '+ū', '+ā')
def addperi(pair):
    (center_let, peri_let) = pair
    center = list(getcode(center_let))        
                    # Recursion happens only for SpecialCombos
                    # list used for dereferencing
    peri   = Codes[peri_let] 
    center[LETTER] += peri[LETTER]
    if peri_let in Sides:
        if   center[SIDE] <= 0:     sidelen = 0
        elif center[SIDE] <= 0xf:   sidelen = 4
        else:                        sidelen = 8
        center[SIDE] |= peri[SIDE] << sidelen
    else:
        if center[TALA] == Codes['✓'][TALA]:
            center[TALA]  = peri[TALA]
        else:                                    # Special case for ట
            center[TALA] |= peri[TALA]
    return center

def shift(center):
    shifted = ('్' + center[LETTER],
            0,0,0,0,0,0,
            center[TOP_CIRCLES], center[TOP_AROUND], center[TOP_MID], center[TOP_VATTU],
            0)    
    return shifted
...
def writecsv(fname):
    ...
    headstr = 'char unicode ' + ' '.join(delredundants(header))

    f = open(fname, 'w')
    f.write(headstr+'n')
    for (c, i) in char_indices.items():
        f.write(c + ' ' + unicode_list[i] + ' ' +
                      ' '.join(map(str, mallicode_list[i])) + 'n')
    def spcr(l):
...
def writepy(fname):
    ...
    f.write("nchar_indices = "+ str(char_indices  ))
    f.write("nunicodes = "    + str(unicode_list  ))
    f.write("nmallicodes = "  + str(mallicode_list))
    f.write("nmalliwts = "    + str(malliwts))
    f.close()

for dirpath, dirnames, filenames in os.walk('/d/imgs/good/'):
...
writecsv('/tmp/mallicodes.csv')
writepy ('/tmp/Mallicodes.py')
